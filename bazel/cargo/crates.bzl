...
def raze_fetch_remote_crates():
    ...
    maybe(
        http_archive,
        name = "raze__proxy_wasm__0_1_4",
        url = "https://crates.io/api/v1/crates/proxy-wasm/0.1.4/download",
        type = "tar.gz",
        sha256 = "d5b944c570b7e30d8b6725753360c5f92311d0888d0e86089e1c651f0d3c2ef3",
        strip_prefix = "proxy-wasm-0.1.4",
        build_file = Label("//bazel/cargo/remote:BUILD.proxy-wasm-0.1.4.bazel"),
    )
